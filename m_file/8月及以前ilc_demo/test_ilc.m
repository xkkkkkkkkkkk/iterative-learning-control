...
robot_params.m = [372.27, 232.06, 202.83, 66.0035248, 0, 0]'; % 各连杆质量
...
robot_params.fc = [1.260764,2.350470,1.794723,0.4703540,0.4563651,0.2159434];  % 库仑摩擦
robot_params.fb = [599.36, 476.58, 374.72, 56.84, 126.94, 126.08]; % 粘滞摩擦
robot_params.fs = [599.361/(256.857^2),476.578/(269.176^2),374.719/(251.333^2),...
                   56.835/(188.855^2),126.935/(190.192^2),126.084/(131.340^2)];   % 静态摩擦力系数(约为库仑摩擦的1.2倍)
